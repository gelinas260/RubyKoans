...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Inject takes the initial value passed to it, the accumulator, runs the block,
    # stores the last value of the block and continues to iterate through
    # performing the block logic on the last value stored.
  end
